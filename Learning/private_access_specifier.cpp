/**
 * @file private_access_specifier.cpp
 * @author KUSHAGRA JAISWAL 
 * @date 2022-10-16
 * @copyright Copyright (c) 2022
 */
 
/* Program to understand the concept of classes and Private access specifier in C++. */
...
// main function 
     ...
     cout<<"Concepts of classes and Private access specifier"<<endl<<endl;
